...
void CheckTableColumns(char* server, char *user, char* password, char* database, char* link, char* impersonate, char* table)
{
    SQLHENV env		= NULL;
    SQLHSTMT stmt 	= NULL;
	SQLHDBC dbc 	= NULL;
...
) 
{
	...
	CheckTableColumns(server, user, password, database, link, impersonate, table);
...
int main()
{
	...
	CheckTableColumns("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", NULL, NULL, "spt_monitor");

	internal_printf("\n\n============ IMPERSONATE TEST ============\n\n");
	CheckTableColumns("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", NULL, "sa", "spt_monitor");

	internal_printf("\n\n============ LINK TEST ============\n\n");
	CheckTableColumns("castelblack.north.sevenkingdoms.local", NULL, NULL, "master", "BRAAVOS", NULL, "spt_monitor");
}
